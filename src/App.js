...
class App extends Component {
  ...
  return (
    <main className="App">
      <header>
        <NavLink to='/genderfacts' activeClassName='name-whatever-you-want' activeStlye={{background:'red', color:'white'}}>Gender Gap Facts</NavLink>
        <NavLink to='/agefacts' activeClassName='name-whatever-you-want' activeStlye={{background:'red', color:'white'}}>Age Gap Facts</NavLink>
        <NavLink to='/racialfacts' activeClassName='name-whatever-you-want' activeStlye={{background:'red', color:'white'}}>Racial Gap Facts</NavLink>
